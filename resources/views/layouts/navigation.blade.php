<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Toy Store</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @if (auth()->user() && auth()->user()->is_admin)
            ...
            <li class="menu-item {{ request()->routeIs('mainan.index') ? 'active' : '' }}">
                <a href="{{ route('mainan.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-package"></i>
                    <div data-i18n="Account Settings">Manajemen Produk</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('kategori.index') ? 'active' : '' }}">
                <a href="{{ route('kategori.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-category"></i>
                    <div data-i18n="Account Settings">Manajemen Kategori</div>
                </a>
            </li>
        @endif
        @if (auth()->user())
